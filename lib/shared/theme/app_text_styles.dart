...
class AppTextStyles {
  ...
  static final titleHomePrimary = GoogleFonts.lexendDeca(
    fontSize: 32,
    fontWeight: FontWeight.w600,
  ...
  static final titleRegularInput = GoogleFonts.lexendDeca(
    fontSize: 20,
    fontWeight: FontWeight.w400,
  ...
  static final titleListTraling = GoogleFonts.lexendDeca(
    fontSize: 17,
    fontWeight: FontWeight.w500,
    color: AppColors.input,
  );
  static final titleListTilePrimary = GoogleFonts.lexendDeca(
    fontSize: 17,
    fontWeight: FontWeight.w600,
    color: AppColors.primary,
  );
  ...
  static final trailingPrimary = GoogleFonts.lexendDeca(
    fontSize: 16,
    fontWeight: FontWeight.w400,
    color: AppColors.primary,
  );
  ...
  static final buttonRegularPrimary = GoogleFonts.inter(
    fontSize: 15,
    fontWeight: FontWeight.w500,
    color: AppColors.primary,
  );
  ...
  static final captionBodyDelete = GoogleFonts.inter(
    fontSize: 13,
    fontWeight: FontWeight.w400,
    color: AppColors.delete,
  );
